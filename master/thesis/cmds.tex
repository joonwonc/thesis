...
\newcommand{\bsv}[6]{
\begin{tabular}{@{}p{7cm}@{}}
\ensuremath{#1}\;\textit{#2}\ensuremath{#3}:\\
\hline
\ensuremath{
\begin{array}{@{}l}
#4
...
\newcommand{\inlinedmssymb}{\ensuremath{\hookleftarrow}}
\newcommand{\inlinedms}[2]{\ensuremath{#1 \inlinedmssymb{} #2}}
\newcommand{\inlinedmmsymb}{\ensuremath{\hookleftarrow}}
