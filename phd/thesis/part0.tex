...
In \autoref{sec-nutshell}, we have looked at a very specific protocol design.
...
\subsubsection{Cache-centric vs. Memory-centric}
...
\subsubsection{Blocking vs. Nonblocking}

%% \subsubsection{Stalling vs. Nonstalling}

\subsubsection{Direct-mapped vs. Fully-associative vs. Set-associative}

\subsubsection{3-hop vs. 4-hop}

%% - MSI, MESI, MOSI, MOESI, MESIF, ..
