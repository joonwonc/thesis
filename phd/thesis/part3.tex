...
\autoref{fig-evaluation} shows the performance result.
...
Various model checkers like Murphi~\cite{murphi:Dill:1996,murphi:Dill:1992}, SMV~\cite{smv:McMillan:1993,McMillan:1992,smv:Jhala:2001}, and TLA+~\cite{tla:Lamport:2002, Joshi:2003} have been used, but in the beginning applicability was limited to finite numbers of caches or specific protocols due to conventional state-space-explosion issues.
...
\todo{Already mentioned in related work I}
...
\todo{Parameterization more? Emerson:2003}
