...
Another way to ensure safe interleavings is to prove commutativity between two adjacent state transitions representing partial executions by two different execution units, called (commuting) reduction~\cite{reduction}.
