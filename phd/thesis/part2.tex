...
For example, in order to establish ``rely'' conditions $R$ from the original Hoare triple $\{P\}C\{Q\}$, the precondition $P$ should be stable (not interfered with) under $R$, \ie{} $\forall s, t.\; P(s) \wedge R(s, t) \to P(t)$.
