...
\section{Cache-Coherence Protocol as a Distributed-System Protocol}
...
In order to define serializability formally, we first provide basic definitions of atomic histories and transactions, presented in \autoref{fig-atomic-trs}.
...
Transactions are the next level of abstraction, defined by the final rules in \autoref{fig-atomic-trs}.
