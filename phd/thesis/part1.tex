...
Serializability has been mainly developed and used in database systems and software distributed systems.
...
It is quite natural to think of sequential histories only with atomic histories, \eg{} like the one in \autoref{fig-sz-ex}, but why do we have to separate external input/output labels from atomic histories?
