...
\subsection{State-Transition Steps}
...
\subsection{Behaviors and correctness}
...
\subsection{Invariants and predicate messages}

\subsection{Predicate messages in atomic histories}
