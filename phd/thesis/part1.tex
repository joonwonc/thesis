...
\begin{definition}[Predicate Messages]
  A predicate message, denoted as \spredmsg{S}{im}{P}, is an invariant over a system $S$ that additionally requires $im$, a pair of a channel and a message, to be in the system:
  \begin{displaymath}
