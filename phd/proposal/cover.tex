...
I would like to propose a framework called Hemiola, which is for designing, proving, and synthesizing various cache-coherence protocols.
...
This proposal will also suggest a methodology to synthesize protocols designed in Hemiola into hardware; a protocol compiler in the framework will take such a role, employing predesigned cache structures and controller circuitry.
}
