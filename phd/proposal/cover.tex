...
\def\abstract{
  ...
  A protocol compiler in the framework would take such a role, which takes a protocol described in Hemiola and generates a corresponding hardware implementation, equipped with optimized cache structures and controller circuitry.
}
