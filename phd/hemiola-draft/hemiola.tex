...
%% WIP
%% WIP
\newcommand*\greencircled[1]{
  \tikz[baseline=(char.base)]{
    \node[shape=circle,draw,inner sep=1pt, minimum size=11pt, fill=forestgreen, text=white] (char) {\tiny #1};}}
\newcommand*\bluecircled[1]{
  \tikz[baseline=(char.base)]{
    \node[shape=circle,draw,inner sep=1pt, minimum size=11pt, fill=airforceblue, text=white] (char) {\tiny #1};}}
\begin{figure*}[t]
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{tabular}{c}
      \begin{tikzpicture}
        ...
        \node[label={[label distance=-6pt,forestgreen]left:{\small {\sf rqM}}},color=forestgreen] at (-1.6, -2.05) {$\bullet$};
        \node[label={[label distance=-6pt,forestgreen]right:{\small {\sf rsM}}},color=forestgreen] at (-1.4, -2.05) {$\bullet$};
        % Between P and C_1
        \pic at (0, 0) {skeleton-midx-pc1};
        \node[label={[label distance=-6pt,forestgreen]left:{\small {\sf rqM}}},color=forestgreen] at (-1, -0.7) {$\bullet$};
        \node[label={[label distance=-9pt,forestgreen]below left:{\small {\sf rsM}}},color=forestgreen] at (-0.6, -0.7) {$\bullet$};
        % Between P and C_2
        \pic at (0, 0) {skeleton-midx-pc2};
        \node[label={[label distance=-9pt,forestgreen]below right:{\small {\sf rsI}}},color=forestgreen] at (0.6, -0.7) {$\bullet$};
        \node[label={[label distance=-6pt,forestgreen]right:{\small {\sf rqI}}},color=forestgreen] at (1, -0.7) {$\bullet$};

        % Curves
        \draw [->,color=forestgreen] (-2.4, -2.1) to[out=90,in=-135] node[left] {\greencircled{$1$}} (-1.5, -0.3);
        \draw [->,color=forestgreen] (-1.4, -0.2) to[out=45,in=115] node[above] {\greencircled{$3$}} (1.7, -0.7);
        \draw [->,color=forestgreen] (1.8, -0.9) to[out=-60,in=-50,distance=1.5cm] node[below] {\greencircled{$4$}} (0.5, -1.0);
        \draw [->,color=forestgreen] (0.4, -0.9) to[out=135,in=45,distance=0.7cm] node[below] {\greencircled{$5$}} (-0.4, -0.9);
        \draw [->,color=forestgreen] (-0.5, -1.0) to[out=225,in=90] node[below right] {\greencircled{$7$}} (-1.1, -1.8);
      \end{tikzpicture}\\
      \begin{tikzpicture}
        \pic at (0, 0) {skeleton-pcce2={$P$}{$C_1$}{$C_2$}};
        % C_2 external
        \pic at (0, 0) {skeleton-midx-e2};
        \node[label={[label distance=-6pt,airforceblue]right:{\small {\sf rqM}}},color=airforceblue] at (1.6, -2.05) {$\bullet$};
        \node[label={[label distance=-6pt,airforceblue]left:{\small {\sf rsM}}},color=airforceblue] at (1.4, -2.05) {$\bullet$};
        % Between P and C_1
        \pic at (0, 0) {skeleton-midx-pc1};
        \node[label={[label distance=-6pt,airforceblue]right:{\small {\sf rqM}}},color=airforceblue] at (1, -0.7) {$\bullet$};
        \node[label={[label distance=-9pt,airforceblue]below right:{\small {\sf rsM}}},color=airforceblue] at (0.6, -0.7) {$\bullet$};
        % Between P and C_2
        \pic at (0, 0) {skeleton-midx-pc2};
        \node[label={[label distance=-9pt,airforceblue]below left:{\small {\sf rsI}}},color=airforceblue] at (-0.6, -0.7) {$\bullet$};
        \node[label={[label distance=-6pt,airforceblue]left:{\small {\sf rqI}}},color=airforceblue] at (-1, -0.7) {$\bullet$};

        % Curves
        \draw [->,color=airforceblue] (2.4, -2.1) to[out=90,in=-45] node[right] {\bluecircled{$2$}} (1.5, -0.3);
        \draw [->,color=airforceblue] (1.4, -0.2) to[out=135,in=65] node[above] {\bluecircled{$6$}} (-1.7, -0.7);
        \draw [->,color=airforceblue] (-1.8, -0.9) to[out=-120,in=-130,distance=1.5cm] node[below] {\bluecircled{$8$}} (-0.5, -1.0);
        \draw [->,color=airforceblue] (-0.4, -0.9) to[out=45,in=135,distance=0.7cm] node[below] {\bluecircled{$9$}} (0.4, -0.9);
        \draw [->,color=airforceblue] (0.5, -1.0) to[out=-45,in=90] node[below left] {\bluecircled{$10$}} (1.1, -1.8);
      \end{tikzpicture}
    \end{tabular}
  \end{subfigure}
  \begin{subfigure}[b]{0.6\textwidth}
    ...
    \begin{tabular}{c}
      \begin{tabular}{c|cccccccccc}
        \hline
        $C_1$ & \greencircled{$1$} & & & & & & \greencircled{$7$} & \bluecircled{$8$} & & \\
        \hline
        $P$ & & & \greencircled{$3$} & & \greencircled{$5$} & \bluecircled{$6$} & & & \bluecircled{$9$} & \\
        \hline
        $C_2$ & & \bluecircled{$2$} & & \greencircled{$4$} & & & & & & \bluecircled{$10$} \\
        \hline
      \end{tabular}\\
      $\downarrow$ (after a reduction between \bluecircled{$6$} and \greencircled{$7$})\\
      \begin{tabular}{c|cccccccccc}
        \hline
        $C_1$ & \greencircled{$1$} & & & & & \greencircled{$7$} & & \bluecircled{$8$} & & \\
        \hline
        ...
        \hline
      \end{tabular}\\
      $\downarrow^\ast$ (after some reductions between \bluecircled{$2$} and \greencircled{$3$}\greencircled{$4$}\greencircled{$5$}\greencircled{$7$})\\
      \begin{tabular}{c|cccccccccc}
        \hline
        $C_1$ & \greencircled{$1$} & & & & \greencircled{$7$} & & & \bluecircled{$8$} & & \\
        \hline
...
\todo{Add number labels to the channels to distinguish them better.}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.48\columnwidth}
    \centering
    \begin{tikzpicture}
      \pic at (0, 0) {skeleton-pc={$P(S, v, S_{\tuple{1, 2}})$}{$C_1(S, v)$}};
  ...
  \begin{subfigure}[b]{0.48\columnwidth}
    \centering
    \begin{tikzpicture}
      \pic at (0, 0) {skeleton-pc={$P(S, v, S_{\tuple{1, 2}})$}{$C_2(I, \cdot)$}};
...
\todo{Explain the meaning of $\circ$ and $\bullet$, as early as possible.}
...
At this moment the child \emph{sets a lock} not to allow any further external requests for the value.
...
\todo{Can we think of a better notation for atomic histories?}
...
\begin{figure}[h]
  \begin{tabular}{c}
    ...
    \begin{math}
      \small
      \begin{array}{rl}
        h \triangleq & [\lblInt{\idxOf{C_2}}{\idxOf{r_3}}{\listsingle{(8, \textsf{rqI})}}{\listsingle{(6, \textsf{rsI})}};\\
          & \lblInt{\idxOf{P}}{\idxOf{r_2}}{\listsingle{(3, \textsf{rqM})}}{\listsingle{(8, \textsf{rqI})}};\\
          & \lblInt{\idxOf{C_1}}{\idxOf{r_1}}{\listsingle{(1, \textsf{rqM})}}{\listsingle{(3, \textsf{rqM})}}]\\
      \end{array}
    \end{math}
  \end{tabular}
...
\todo{Haven't defined ``internally'' atomic histories yet.}
