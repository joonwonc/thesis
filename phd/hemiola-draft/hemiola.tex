...
\newcommand{\propt}{\ensuremath{\mathbb{B}}}
...
\item Using the protocol language, we provide the complete correctness proofs of three hierarchical cache-coherence protocols:
  inclusive and noninclusive MSI protocols and a noninclusive MESI protocol (\autoref{sec-case-study}).
...
$\listnil{}$, $(\listcons{\listof{t}}{h})$, $(\listapp{\listof{l_1}}{\listof{l_2}})$, $(\listsub{\listof{l_1}}{\listof{l_2}})$, and
$(\listdisj{\listof{l_1}}{\listof{l_2}})$ denote nil, cons, append, subtraction, and disjointness of lists, respectively.
We use the opposite order to the convention for cons to present the natural left-to-right growth of a list as a sequence.
Similarly, a list $[a; b; c]$ grows to the right, \ie{} $c$ is the head of the list.
      ...
      \begin{math}
        ...
        \begin{array}{cc}
          ...
          & \inference[StepsCons:]{\semsteps{S}{s_0}{\listof{l}}{s_1}
            & \semstep{S}{s_1}{l_1}{s_2}}{\semsteps{S}{s_0}{\listcons{\listof{l}}{l_1}}{s_2}} \\
...
\begin{definition}[Nonconfluence]
  ...
  \begin{align*}
    ...
    & \to \hitlv{S}{(\listcons{\listof{h}}{h_0})},
  \end{align*}
...
\begin{definition}
  ...
  \begin{displaymath}
    ...
    \begin{array}{l}
      ...
      \quad \forall s_1, s_2.\; \semsteps{S}{s_1}{\listapp{h_1}{\listapp{h}{h_2}}}{s_2}
      \to \semsteps{S}{s_1}{\listapp{h}{\listapp{h_1}{h_2}}}{s_2}.\\
      \rpush{S}{h_1}{h_2}{h} \triangleq\\
      \quad \forall s_1, s_2.\; \semsteps{S}{s_1}{\listapp{h_1}{\listapp{h}{h_2}}}{s_2}
      \to \semsteps{S}{s_1}{\listapp{h_1}{\listapp{h_2}{h}}}{s_2}.\\
    \end{array}
  \end{displaymath}
\end{definition}
...
\begin{definition}
  ...
  \begin{displaymath}
    ...
    \begin{array}{rrl}
      ...
      & \forall \listof{h}, s_2. & \semsteps{S}{s_1}{\listapp{h_1}{\listapp{\listconcat{\listof{h}}}{h_2}}}{s_2} \to\\
      & \exists \listof{h}_{\textrm{l}}, \listof{h}_{\textrm{r}}. & \semsteps{S}{s_1}{\listapp{\listconcat{\listof{h_{\textrm{l}}}}}{\listapp{h_1}{\listapp{h_2}{\listconcat{\listof{h_{\textrm{r}}}}}}}}{s_2}\\
