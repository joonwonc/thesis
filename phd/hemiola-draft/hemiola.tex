...
%% As introduced in \autoref{sec-example}, the main challenge when designing a cache-coherence protocol is to figure out correct topology, communication channels, and locking mechanisms.
