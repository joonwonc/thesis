...
Recall that the serializability (defined in \autoref{sec-sz-in-hemiola}) does not require to preserve the behavior of a history, but the sequential history to reach to the same state.
