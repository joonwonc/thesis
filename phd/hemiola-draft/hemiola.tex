...
It does not restrict the notion since when continuous histories are found in a legal history, the externally continuous histories can be always found at the beginning of the whole transaction.
...
On top of the precise notion of interleaving, we provide a formal definition that reflects the intuition about merging two atomic-history fragments, called \emph{mergeability}.
