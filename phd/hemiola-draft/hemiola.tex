...
\end{theorem}
While we only provided the intuition why this theorem holds, interested readers are referred to \autoref{sec-appx-proof-sz}, which presents the required formalization and the proof of this theorem.
