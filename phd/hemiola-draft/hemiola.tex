...
\todo{- How to provide the proof intuition: 1) if we can serialize any two interleaving transactions, we can prove serializability of the system, 2) now this figure explains how the two transactions are serialized, using commuting reductions, and 3) the reason why these two transitions commute is blah blah..}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    ...
    \begin{tabular}{c}
      \begin{tikzpicture}
        ...
        \draw [->,color=myred] (0.4, -0.8) to[out=135,in=45,distance=0.6cm] (-0.3, -0.7); %% node[below] {\rdcircfl{5}{rsud}}
      ...
      \begin{tikzpicture}
        ...
        \draw [->,color=myblue] (0.3, -0.7) to[out=135,in=45,distance=0.5cm] (-0.3, -0.7); %% node[below] {\blcircfl{6}{rqud}}
    ...
    \begin{tabular}{c}
      \multicolumn{1}{l}{
        \begin{tikzpicture}
          ...
          \draw [>=stealth,->,line width=1pt] (0, 0) to (6, 0);
        \end{tikzpicture}}\\
