...
\todo{Add McMillan CompMC~\cite{McMillan:1999}.}
\todo{Add the ``Flow'' papers~\cite{flow:Talupur:2008,flow:OLeary:2009,flow:Sethi:2014}.}
\todo{Add Fractal and PVCoherence~\cite{Zhang:2010,Zhang:2014}.}

Model checking has long been widely used to verify cache-coherence protocols.
Various model checkers like TLA+~\cite{tla:Lamport:2002}, SMV~\cite{smv:Jhala:2001}, and Murphi~\cite{murphi:Dill:1996} have been used, but due to conventional state-explosion issues, applicability has been limited to finite numbers of caches or specific protocols~\cite{Joshi:2003,Komuravelli:2014}.
