...
\newcommand*\rdcircf[1]{
  \tikz[baseline=(char.base)]{
    \node[shape=circle, draw, inner sep=0pt, minimum size=8pt, fill=mordantred19, text=white] (char) {\tiny\sffamily #1};}}
\newcommand*\blcircf[1]{
  \tikz[baseline=(char.base)]{
    \node[shape=circle, draw, inner sep=0pt, minimum size=8pt, fill=mediumtealblue, text=white] (char) {\tiny\sffamily #1};}}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % C_1 external
    \pic at (0, 0) {skeleton-midx-e1};
    \node[label={[label distance=-6pt,mordantred19]left:{\rdcircsm{a}{\small\sf rqM}}},color=mordantred19] at (-1.6, -2.05) {$\bullet$};
    % C_2 external
    \pic at (0, 0) {skeleton-midx-e2};
    \node[label={[label distance=-6pt,mediumtealblue]left:{\blcircsm{e}{\small\sf rqM}}},color=mediumtealblue] at (1.4, -2.05) {$\bullet$};
    % Between P and C_1
    \pic at (0, 0) {skeleton-midx-pc1};
    \node[label={[label distance=-6pt,mordantred19]left:{\rdcircsm{b}{\small\sf rqM}}},color=mordantred19] at (-1, -0.7) {$\bullet$};
    % Between P and C_2
    \pic at (0, 0) {skeleton-midx-pc2};
    \node[label={[label distance=-9pt,mordantred19]below right:{\rdcircsm{d}{\small\sf rsI}}},color=mordantred19] at (0.8, -0.7) {$\bullet$};
    \node[label={[label distance=-9pt,mordantred19]above right:{\rdcircsm{c}{\small\sf rqI}}},color=mordantred19] at (1, -0.7) {$\bullet$};
    \node[label={[label distance=-9pt,mediumtealblue]below left:{\blcircsm{f}{\small\sf rqM}}},color=mediumtealblue] at (0.6, -0.7) {$\bullet$};
    ...
    \draw [->,color=mediumtealblue] (0.9, -1.9) to[out=90,in=-45] node[outer sep=-3pt, below left] {\blcircf{2}} (0.3, -1.2);
  \end{tikzpicture}
...
\todo{Fix all the explanations along with the new figure.}
