  ...
  \begin{subfigure}[b]{0.18\textwidth}
    ...
    \begin{tabular}{c}
      ...
      \begin{tikzpicture}
        ...
        % Curves
        \draw [->,color=myred] (1.2, 0.4) to[out=-135,in=90] node[below right] {\rdcircflsm{3}{rqud}} (0.5, -0.6);
      \end{tikzpicture}\\
    \end{tabular}
...
As seen in the two cases in \autoref{fig-ex-sz-state-trs}, we can argue the merge process just by looking at which rule templates are used.
\todo{}
