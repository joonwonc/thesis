...
\newcommand{\rdrecmsg}[2]{{\color{mordantred19}\rdrecsm{#1}{\sf #2}}}
\newcommand{\rdrecmsgsm}[2]{\rdrecmsg{#1}{\small #2}}
\newcommand{\blrecmsg}[2]{{\color{mediumtealblue}\blrecsm{#1}{\sf #2}}}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % C_1 external
    %% \pic at (0, 0) {skeleton-midx-e1};
    \node[label={[label distance=-6pt,mordantred19]left:{\rdrecmsgsm{a}{rqM}}},color=mordantred19] at (-1.6, -2.05) {$\bullet$};
    % C_2 external
    %% \pic at (0, 0) {skeleton-midx-e2};
    \node[label={[label distance=-6pt,mediumtealblue]left:{\blrecmsgsm{e}{rqM}}},color=mediumtealblue] at (1.4, -2.05) {$\bullet$};
    % Between P and C_1
    %% \pic at (0, 0) {skeleton-midx-pc1};
    \node[label={[label distance=-6pt,mordantred19]left:{\rdrecmsgsm{b}{rqM}}},color=mordantred19] at (-1, -0.7) {$\bullet$};
    % Between P and C_2
    %% \pic at (0, 0) {skeleton-midx-pc2};
    \node[label={[label distance=-9pt,mordantred19]below right:{\rdrecmsgsm{d}{rsI}}},color=mordantred19] at (0.8, -0.7) {$\bullet$};
    \node[label={[label distance=-9pt,mordantred19]above right:{\rdrecmsgsm{c}{rqI}}},color=mordantred19] at (1, -0.7) {$\bullet$};
    \node[label={[label distance=-9pt,mediumtealblue]below left:{\blrecmsgsm{f}{rqM}}},color=mediumtealblue] at (0.6, -0.7) {$\bullet$};
...
\begin{figure}[h]
  \begin{tabular}{c}
    \begin{tikzpicture}
      ...
      % Curves
      \draw [->,color=mordantred19] (-2.2, -1.85) to[out=90,in=-110] node[left=3pt] {$r_1$} (-1.6, -0.95);
...
\subsection{The Payoff: Predicate Messages in Transactions}
\label{sec-atomic-invariants}

\newcommand{\msgsf}[1]{\ensuremath{\textsf{#1}}}
\newcommand{\msgsfsm}[1]{{\small\ensuremath{\textsf{#1}}}}
\newcommand{\rdmsg}[1]{{\color{mordantred19}\msgsf{#1}}}
\newcommand{\rdmsgsm}[1]{{\color{mordantred19}\msgsfsm{#1}}}
\newcommand{\blmsg}[1]{{\color{mediumtealblue}\msgsf{#1}}}
\newcommand{\blmsgsm}[1]{{\color{mediumtealblue}\msgsfsm{#1}}}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % C_1 external
    \pic at (0, 0) {skeleton-midx-e1};
    \node[label={[label distance=-6pt,mordantred19]right:{\msgsfsm{rsM}}},color=mordantred19] at (-1.4, -2.05) {$\bullet$};
    % Between P and C_1
    \pic at (0, 0) {skeleton-midx-pc1};
    \node[label={[label distance=-9pt,mordantred19]below right:{\msgsfsm{rsM}}},color=mordantred19] at (-0.6, -0.7) {$\bullet$};
    % Between P and C_2
    \pic at (0, 0) {skeleton-midx-pc2};
    \node[label={[label distance=-6pt,mediumtealblue]right:{\small\predmsg{\msgsf{rsM}}{C_1.\textrm{st} = I \wedge P.\textrm{st} = I}??}},color=mediumtealblue] at (1, -0.7) {$\bullet$};

    % Curves
    \draw [->,color=mordantred19] (-0.6, -1.15) to[out=225,in=90] node[below right=-3pt] {{\small\color{mordantred19} $r_1: (C_1.\textrm{st} \leftarrow M)$}} (-1.2, -1.85);
...
Recalling our motivating example from \autoref{sec-example}, when the system has a message of a kind \msgsf{rsM}, we expect the parent and the other child (not the requestor) has the I status (like {\color{mediumtealblue} $\{C_1.\textrm{st} = I \wedge P.\textrm{st} = I\}$} in the figure).
...
\end{definition}
\noindent Note that atomic invariant takes the live messages ($\listof{m_o}$) from an atomic history as an additional argument, compared with ordinary invariants.
